<?php
  ...
  $productosvender = join_productovender_table();
?>
      ...
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
         <div class="pull-right">
           <a href="add_product.php" class="btn btn-primary">Agragar producto a vender</a>
         </div>
        </div>
        <div class="panel-body">
          <table class="table table-bordered">
            ...
            <tbody>
              <?php foreach ($productosvender as $product):?>
              <tr>
